...
//  SwiftCache
//
//  Created by Tbxark on 05/10/2016.
...
fileprivate typealias Word = UInt32
...
fileprivate struct Digest {
    ...
    var checksum: String {
        return MD5Encoder.encodeMD5Digest(digest)
    }
}
...
struct MD5Encoder {
    ...
    private static func md5(_ bytes: [Byte]) -> Digest {
        // Initialization
        let s: [Word] = [
    ...
    fileprivate static func encodeMD5Digest(_ digest: [Byte]) -> String {
        assert(digest.count == 16)
    ...
    static func encodeMd5(string: String) -> String {
